...
function openExerciseTimePicker(duration, onApply) {
...
function makeTimePickerTrigger(duration = { hours: 0, minutes: 0, seconds: 0 }) {
  ...
  valueText.textContent = formatDuration(value);
  ...
  const field = makeFieldWithHelper(button);
  field.classList.add('exercise-time-field');
