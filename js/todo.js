...
function renderDailyInTodo() {
  ...
  if (tasks.length === 0) { wrap.style.display = 'none'; return; }
...
document.getElementById('todoInput').addEventListener('keydown', e => { if (e.key === 'Enter') { e.preventDefault(); confirmTodo(); } });
